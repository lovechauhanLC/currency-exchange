...
function App() {
  ...
  return (
      <div className='w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat'
            style={{backgroundImage: `url('https://cdn.britannica.com/83/189283-131-4BB2C246/Banknotes-world.jpg`}}
      >
        <div className='w-full'>
          <div className='w-full max-w-md mx-auto border border-gray-50 rounded-lg p-5 backdrop-blur-sm bg-white/30 '>
            <form onSubmit={(e) => {e.preventDefault(); convert()}} >
              ...
              <button className='w-full bg-blue-600 text-white px-4 py-3 rounded-lg mx-auto' type='submit'>
